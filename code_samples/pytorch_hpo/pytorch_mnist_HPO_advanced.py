...
try:
    ...
    num_hidden_layers = int(hyper_params.get("num_hidden_layers" , "128"))
    dropout_rate = float(hyper_params.get("dropout_rate" , "0.1"))
except:
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(9216, num_hidden_layers)
        self.fc2 = nn.Linear(num_hidden_layers, 10)
